...
def loginpage(request):
    ...
    return render(request,'Registration/loginPage.html',{'Render_to':Render_to})
...
def ValidationPage(request):
    if request.user.is_admin:
        ...
        return render(request,'rent/Validate.html',{'Forvalidate':val,'ForvalidateMess':messval})
    else:
...
def UpdateRooms(request,pk):
    ...
    if request.user.id == obj.user.id:
       return render(request,'rent/UpdatePostRooms.html',{'data': data})
    ...
    def create(self, request):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            send_mail("Validate This Post  to upload ", "http://127.0.0.1:8000/rent/validationpage/",
                       'dominicmuturi2018@gmail.com', ['dominicmuturi2018@gmail.com'])
